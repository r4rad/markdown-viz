const ICONS: Record<string, string> = {
  ...
  'cloud-sync': `<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.3"><path d="M11.5 10.5H12a3 3 0 0 0 0-6h-.2A4.5 4.5 0 0 0 3 6.5V7a2.5 2.5 0 0 0 0 5h1.5"/><line x1="8" y1="9" x2="8" y2="14"/><polyline points="6,11 8,9 10,11"/></svg>`,
